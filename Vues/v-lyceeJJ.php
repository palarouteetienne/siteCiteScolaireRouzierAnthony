            ...
            <nav class="navbar navbar-default">
              ...
              <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll sticky-logo" href="index.php?action=init">
                  <h1><span>Lycée</span>Jean Jaurès</h1>
      ...
      <div class="row">
        ...
        <div class="col-md-8 col-sm-8 col-xs-12">
          <div class="well-middle">
            <div class="single-well">
              <a href="#">
                <h4 class="sec-head">Le Lycée Jean Jaurès</h4>
              </a>
              <p>
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="awesome-menu ">
              <ul class="project-menu">
                ...
                <li>
                  <a href="#" data-filter=".cap_lyceeJJ">CAP</a>
                </li>
                <li>
                  <a href="#" data-filter=".bacPro_lyceeJJ">Bac Professionnel</a>
                </li>
                <li>
                  <a href="#" data-filter=".option_lyceeJJ">Options</a>
                </li>
              </ul>
            </div>
          </div>
      ...
      <div class="container ">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <!-- Start Map -->
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d2773.949284363437!2d2.1722664157823064!3d45.952296308761944!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sfr!2sfr!4v1548839896009" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
            <!-- End Map -->
          </div>
          <!-- End Google Map -->
