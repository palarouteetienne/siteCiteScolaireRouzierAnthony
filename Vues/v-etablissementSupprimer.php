...
<head>
	...
	<title>Etablissement Suppression</title>

	<link href="./css/styleFormulaire.css" rel="stylesheet">

	<script>

		function myFunction(num, nomCS, nom, rue, cp, ville, tel, mail, mot)
		{
			document.getElementById("Num").value = num;
			document.getElementById("NomCS").value = nomCS;
...
<body style="background:url(img/index/fond3.png) no-repeat center fixed;">
	...
	<div id="form-main" style="padding-top: 25%; padding-bottom: 5%;">
		<div id="form-div">
	      	...
	      	<center>
	      		<h2 style="color: white"> Etablissement Suppression </h2>
	      	</center>
	      	<br>
  	...
  	<form action="index.php?action=suppE" method="post">
		<div class="modal fade" id="exampleModal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        <h5 class="modal-title" id="exampleModalLabel">Suppression de l'Etablissement</h5>
		      ...
		      <div class="modal-body">
		      	...
		      	<input readonly type="text" name="NomCS" id="NomCS"/>
		      	...
		      	<input readonly type="text" name="Rue" id="Rue"/>
		      	...
		      	<input readonly type="text" name="CP" id="CP"/>
		      	...
		      	<input readonly type="text" name="Ville" id="Ville"/>
		      	...
		      	<input readonly type="text" name="Tel" id="Tel"/>
		      	...
		      	<input readonly type="text" name="Mail" id="Mail"/>
		      	...
		      	<textarea readonly cols="60" rows="5" name="Mot" Id="Mot"></textarea>
