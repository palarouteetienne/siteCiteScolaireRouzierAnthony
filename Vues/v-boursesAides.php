            ...
            <!-- Navigation -->
              ...
              <ul class="nav nav-tabs">
                ...
                <li>
                  ...
                  <li>
                    <a class="nav-link active" data-toggle="tab" href="index.php?action=citeScolaireBA#bourses_aides">Bourses & Aides</a>
                  </li>
              </ul>
              </div>
            </nav>
...
<!-- Start bourses et aides Area -->
<div id="boursesAides" class="portfolio-area area-padding fix">
    <div class="container">
      <div class="row">
      ...
      <div class="row"> <!-- Début menu page bourses et aides -->
      </div> <!-- Fin menu page bourses et aides -->
