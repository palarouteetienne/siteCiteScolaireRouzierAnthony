            ...
            <!-- Navigation -->
              ...
              <ul class="nav nav-tabs">
                ...
                <li>
                  ...
                  <li>
                    <a class="nav-link active" data-toggle="tab" href="index.php?action=citeScolaireIns#inscription">Inscription</a>
                  </li>
                  <li>
...
<div id="internat" class="portfolio-area area-padding fix">
    <div class="container">
      ...
      <div class="row"> <!-- Début menu page inscription -->
      </div> <!-- Fin menu page inscription -->
