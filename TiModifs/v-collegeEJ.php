...
<head>
  <meta charset="utf-8">
  <title>Collège Eugène Jamot</title>
  ...
  <script type="text/javascript">
    ...
    // Fonction permettant de faire un ancrage avec une variable php mise en variable javascript
    function ancrer()
    {
            ...
            <nav class="navbar navbar-default">
              ...
              <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll sticky-logo" href="index.php?action=init">
                  <h1><span>Collège</span>Eugène Jamot</h1>
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="section-headline text-center" style="padding-top: 10%">
            <h2>Informations Praaaatiques</h2>
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-md-8 col-sm-8 col-xs-12">
          <div class="well-middle">
            <div class="single-well">
              <a href="#">
                <h4 class="sec-head">Le Collège Eugène Jamot</h4>
              </a>
              <p>
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="awesome-menu ">
              <ul class="project-menu">
                ...
                <li>
                  <a href="#" data-filter=".formation_collegeEJ">Formations</a>
                </li>
                <li>
                  <a href="#" data-filter=".option_collegeEJ">Options</a>
                </li>
              </ul>
            </div>
          </div>
