...
(17, 2, 11, 'BTS S.I.O', 6, 'Services Informatiques aux Organisations', 1, '0000-00-00', '0000-00-00'),
...
(5, 'FION', 'FION', 'f@f.f', '$2y$10$tZMRTPECREJoJYKQQbSpeOervLVXJsGnyq.EpnFOrRmA3Q0D7YROC', 0),
(6, 'test', 'test', 'p@p.fr', '$2y$10$FB9uGgQ33ZgX5gR7ME7RBe4pPyf43N1pqnJkdqrV0akUJtPvQKw3m', 0),
(7, 'refq', 'efdc', 'f@f.fr', '$2y$10$IT9eNdfhSqRzeMHGyNmXS.SphXd5kSYLO7V2AGDhCPJuAWXe8SaGS', 0),
(8, 'Dubois', 'Sonia', 'sonia.dubois@ac-limoges.fr', '$2y$10$SnafiDUFd3a2R9oq3aYCueLyubEk4S4evmzGX5UUsCL/6uddMgnda', 0),
...
(11, 'Admin', 'Admin', 'thierry.rouzier@ac-limoges.fr', '$2y$10$kjWc0rte7gV78cYfFNCK../KNL2bGU4nWks3EhVDZEfJwx8OKw5DC', 0);
...
--
ALTER TABLE `article`
  MODIFY `IDA` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
...
--
ALTER TABLE `ressource`
  MODIFY `IDR` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;
